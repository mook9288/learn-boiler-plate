...
- 로그아웃하려는 유저를 데이터베이스에서 찾기
- 찾은 유저의 토큰 지우기

## Authentication Check 인증
...
위와 같이 인증이 이뤄져야만 진입 가능한 페이지가 있다. \
위의 페이지 외에 댓글 작성, 파일 전송, 파일 업로드 등 인증이 필요한 것들이 있다.

들어갈 수 있는 페이지들에 대한 통제는 HOC를 이용할 수 있다.
